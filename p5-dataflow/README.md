[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/h2izr5zS)
...
- [x] Paste your implementation of the lexer in `mjc/mj_lexer.py`
- [x] Paste your implementation of the parser in `mjc/mj_parser.py`
- [x] Paste your implementation of the ast in `mjc/mj_ast.py`
- [x] Paste your implementation of the semantic analysis in `mjc/mj_sema.py`
- [x] Paste your implementation of the type system in `mjc/mj_type.py`
- [x] Paste your implementation of the code generation in `mjc/mj_code.py`
- [x] Paste your implementation of basic blocks in `mjc/mj_block.py`
- [x] Complete the implementation of the dataflow analysis in `mjc/mj_analysis.py`
